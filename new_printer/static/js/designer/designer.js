		...
		$.post('designer/photo_on_review',{"page":1}, function(e) {
			if(e){
				...
				for(var i=0,len=waitlist.length;i<len;i++){
					waitStr+='<div class="designer-works-list-box clearfix"><div class="designer-works-list-bigpic fl"><img src="'+waitlist[i].bigPic+'"/></div><div class="designer-works-list-detail fl"><p class="designer-works-list-title">"'+waitlist[i].name+'"</p><p class="designer-works-list-describe">'+waitlist[i].describe+'</p><div class="designer-works-list-pics clearfix">';
