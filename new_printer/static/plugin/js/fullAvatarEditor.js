function fullAvatarEditor() {
	var id				= 'change_img'			//flash文件的ID
	var file			= '/static/images/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	var	expressInstall	= '/static/images/expressInstall.swf';			//expressInstall.swf的路径
	...
	for(var i = 0; i < arguments.length; i++)
	{
		...
		if(typeof a == 'string')
		{
			if (a.substring(a.length - '/static/images/fullAvatarEditor.swf'.length) == '/static/images/fullAvatarEditor.swf')
			{
				file = a;
			}
			else if (a.substring(a.length - '/static/images/expressInstall.swf'.length) == '/static/images/expressInstall.swf')
			{
				expressInstall = a;
			}
			else
