...
toy_server_path = 'http://%(server)s:8888/static/' % {'server': server}
toy_server_upload = 'http://%(server)s:8888/file/upload' % {'server': server}
toy_server_download = 'http://%(server)s:8888/file/download' % {'server': server}
toy_server_ip = 'http://%(server)s:8888/' % {'server': server}
